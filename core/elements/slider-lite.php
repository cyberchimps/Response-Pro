...
add_action ('response_slider_lite_element', 'response_slider_lite_element_content' );

/**
* Lite slider function
*/
function response_slider_lite_element_content() {
...
?>
	<div class="container-fluid">
		<div id="orbitDemo">
			<a href="<?php echo $link1; ?>" bullet-text="text1">
	   			<img src="<?php echo $slide1 ;?>" alt="Slider" />
	    	</a>
	    	<a href="<?php echo $link2; ?>" bullet-text="text2">
	   			<img src="<?php echo $slide2 ;?>" alt="Slider" />
	    	</a>
	    	<a href="<?php echo $link3; ?>" bullet-text="text3">
