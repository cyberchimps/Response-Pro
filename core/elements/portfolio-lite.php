...
*/
add_action( 'response_portfolio_lite_element', 'response_portfolio_lite_element_content' );

function response_portfolio_lite_element_content() {	
