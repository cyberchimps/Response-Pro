...
* @since 1.0
*/
function response_admin_text_domain() {
	load_theme_textdomain( 'response-admin', TEMPLATEPATH . '/core/admin-languages' );

	    $locale = get_locale();
	    $locale_file = TEMPLATEPATH . "/core/admin-languages/$locale.php";
	    if ( is_readable( $locale_file ) )
		    require_once( $locale_file );
		
		return;    
}
add_action('after_setup_theme', 'response_admin_text_domain');
