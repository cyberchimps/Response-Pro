...
<div id="main_wrap">
	<div class="container-fluid">
		...
		<div class="row-fluid homefeature">
			...
			<div class="span4 newsscroll" id="sidebar">
				<div id="featured">
		...
		<div class="row-fluid">
			...
			<div id="content-row" class="span12">
				<div class="row-fluid">
					<?php   
					$counter = 0;
					$the_query = new WP_Query('showposts=6&orderby=post_date&order=desc&offset=1');  ?>    
					<?php if ($the_query -> have_posts()) : while ($the_query -> have_posts()) : $the_query -> the_post(); ?>
					
					<div class="post_container span4 box_post">            
		...
		<div class="row-fluid">
			<div id="content-row" class="span8">
				<div class="row-fluid">			
					<?php $the_query = new WP_Query('orderby=post_date&order=desc&offset=7&posts_per_page=5');  ?>    
					<?php if ($the_query -> have_posts()) : while ($the_query -> have_posts()) : $the_query -> the_post(); ?> 
