...
function initialize_the_meta_boxes() {
	...
	$mb
		->tab("Page Options")
			->image_select('page_sidebar', 'Select Page Layout', '',  array('options' => array(TEMPLATE_URL . '/library/images/options/right.png' , TEMPLATE_URL . '/library/images/options/left.png', TEMPLATE_URL . '/library/images/options/rightleft.png', TEMPLATE_URL . '/library/images/options/tworight.png', TEMPLATE_URL . '/library/images/options/none.png')))
