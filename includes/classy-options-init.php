...
")
	->section("Design")
		->subsection("Typography")
			->font($themeslug."_font", "Font setting",  array('options' => array("Arial" => "Arial (default)", "Courier New" => "Courier New", "Georgia" => "Georgia", "Helvetica" => "Helvetica", "Lucida Grande" => "Lucida Grande", "Tahoma" => "Tahoma", "Times New Roman" => "Times New Roman", "Verdana" => "Verdana", "Actor" => "Actor", "Coda" => "Coda", "Maven+Pro" => "Maven Pro", "Metrophobic" => "Metrophobic", "News+Cycle" => "News Cycle", "Nobile" => "Nobile", "Tenor+Sans" => "Tenor Sans", "Quicksand" => "Quicksand", "Ubuntu" => "Ubuntu", 'custom' => "Custom"), 'size' => '25', 'preview' => 'true'))
	...
	->section("Header")
		...
		->close_outersection()
			...
			->subsection_end()		
				...
				->upload($themeslug."_logo", "Logo", array('default' => array('url' => TEMPLATE_URL . '/library/images/responselogo.png')))
				->upload($themeslug."_favicon", "Custom Favicon")
		->subsection_end()
		->subsection("Social")
			->images($themeslug."_icon_style", "Icon set", array( 'options' => array('legacy' => TEMPLATE_URL . '/library/images/social/thumbs/icons-classic.png', 'default' =>
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section("Blog")
		...
		->subsection("Single Post")
			->images($themeslug."_single_sidebar", "Sidebar Options", array( 'options' => array("left" => TEMPLATE_URL . '/library/images/options/left.png', "two-right" => TEMPLATE_URL . '/library/images/options/tworight.png', "right-left" => TEMPLATE_URL . '/library/images/options/rightleft.png', "none" => TEMPLATE_URL . '/library/images/options/none.png', "right" => TEMPLATE_URL . '/library/images/options/right.png'), 'default' => 'right'))
		...
		->subsection_end()
		->subsection("404")
			->images($themeslug."_404_sidebar", "Select the Sidebar Type", array( 'options' => array("left" => TEMPLATE_URL . '/library/images/options/left.png', "two-right" => TEMPLATE_URL . '/library/images/options/tworight.png', "right-left" => TEMPLATE_URL . '/library/images/options/rightleft.png', "none" => TEMPLATE_URL . '/library/images/options/none.png', "right" => TEMPLATE_URL . '/library/images/options/right.png'), 'default' => 'right'))
