	...
	->section(__('Header', 'response-admin'))
		...
		->close_outersection()
			->subsection(__('Banner Options', 'response-admin'))
				->upload($themeslug.'_banner', __('Banner Image', 'response-admin'))
				->text($themeslug.'_banner_url', __('Banner URL', 'response-admin'), array('default' => home_url()))
			->subsection_end()		
...
TEMPLATE_URL . '/images/social/thumbs/icons-default.png' ), 'default' => 'default' ) )
	...
	->section(__('Templates', 'response-admin'))
		->subsection(__('Single Post', 'response-admin'))
			->section_order($themeslug.'_single_section_order', __('Drag & Drop Elements', 'response-admin'), array('options' => array('response_index' => __('Post Page', 'response-admin'),'response_breadcrumbs' => __('Breadcrumbs', 'response-admin')), 'default' => 'response_index'))
		...
		->subsection(__('Archive', 'response-admin'))
			...
			->checkbox($themeslug.'_archive_breadcrumbs', __('Breadcrumbs', 'response-admin'), array('default' => true))
	...
	->section(__('Footer', 'response-admin'))
		->open_outersection()
			->checkbox($themeslug.'_disable_footer', __('Footer', 'response-admin'), array('default' => true))
			->text($themeslug.'_footer_text', __('Footer Copyright Text', 'response-admin'))
			->checkbox($themeslug.'_hide_link', __('CyberChimps Link', 'response-admin'), array('default' => true))
			->checkbox($themeslug.'_disable_afterfooter', __('Afterfooter', 'response-admin'), array('default' => true))
		->close_outersection()
	->section(__('Banners',  'response-admin'))
		->checkbox($themeslug.'_header_banner', __('Header Banner', 'response-admin'))
