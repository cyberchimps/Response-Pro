...
")
	->section("Design")
		->subsection("Typography")
			...
			->fontsize($themeslug."_fontsize", __('Select font size', 'response_admin'), array('default' => '25'))
			->info("<h3>Preview</h3><p class='typopreview'>A Free Responsive Starter WordPress Theme Framework. Thank you for using Response.</p>")
